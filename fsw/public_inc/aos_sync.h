...
*
*   \par References:
*     - "AOS Synchronization and Channel Coding", CCSDS 131.0-B-2,
*       Issue 2, August 2011
*
...
#ifndef _IO_AOS_SYNC_
#define _IO_AOS_SYNC_
...
#define AOS_SYNC_ASM_STR "1ACFFC1D" 
#define AOS_SYNC_ASM_SIZE 4

#define AOS_SYNC_SUCCESS           0
#define AOS_SYNC_INVALID_POINTER  -1
#define AOS_SYNC_INVALID_ASM_SIZE -2
#define AOS_SYNC_RANDOMIZE_ERROR  -3
...
*   \return AOS_SYNC_SUCCESS             Always successful.
*
*   \see 
*       #IO_LibInit
...
/******************************************************************************/
/** \brief Perform AOS Synchronization
*
...
*     - In the case of uncoded frame, pass the AOS_SYNC_ASM_UNCODED as the asmHdr
*       and AOS_SYNC_ASM_UNCODED_SIZE as the asmSize parameters.
...
*   \return AOS_SYNC_INVALID_ASM_LENGTH If the ASM length is not an even number 
*                                      or is < 4, as all ASM header are at least
*                                      4 bytes.
*   \return AOS_SYNC_INVALID_POINTER    If any input pointer is NULL
*
*   \see 
*       #AOS_SYNC_PseudoRandomize
*******************************************************************************/
...
/******************************************************************************/
/** \brief Perform AOS Frame PseudoRandomization 
*
*   \par Description/Algorithm
*      Perform the standard CCSDS AOS_Sync channel pseudo randomization.
*
*   \par Assumptions, External Events, and Notes:
